import { GraphQLCofigResult } from './types';
...
export declare function loadConfig({ filepath, rootDir, extensions, throwOnMissing, throwOnEmpty, }: LoadConfigOptions): Promise<GraphQLConfig | undefined>;
export declare class GraphQLConfig {
    ...
    constructor(raw: GraphQLCofigResult, extensions: GraphQLExtensionDeclaration[]);
