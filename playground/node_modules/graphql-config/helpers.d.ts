import { IGraphQLConfig, IGraphQLProject, IGraphQLProjects, GraphQLCofigResult } from './types';
...
export declare function getConfig(filepath: string): Promise<GraphQLCofigResult>;
